...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> getEmployeeByEmail(@PathVariable(value = "email") String employeeEmail) throws EmailNotFoundException {
        Employee employee = employeeRepository.findByEmailId(employeeEmail).orElseThrow(() -> new EmailNotFoundException("Employee not found for this email :: " + employeeEmail));
        return ResponseEntity.ok().body(employee);
    }
